...
print(f"English: {get_sorted_characters('English')}")
print(f"Spanish: {get_sorted_characters('Spanish')}")
print(f"Igbo: {get_sorted_characters('Igbo')}")
print(f"Yoruba: {get_sorted_characters('Yoruba')}")
print(f"Kalabari: {get_sorted_characters('Kalabari')}")
